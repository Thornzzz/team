...
function search_goods_list(fixedSearchPeriod){
	...
	console.log("ifp 값 :" + i_fixedSearch_period.value);
...
function  calcPeriod(search_period){
	...
	function fn_enable_detailed_search(r_search){
		var on_off = document.querySelectorAll('div.on_off *');
		if(r_search.value == "detailed"){
		on_off.forEach(function(element){
...
<body>
	<H3>상품 조회</H3>
	<form name="frm_search_list"  method="post">	
		<TABLE cellpadding="10" cellspacing="10"  >
			<TBODY>
				<TR >
					<TD>
						<input type="radio" name="r_search" value="simple"  checked onClick="fn_enable_detailed_search(this)"/> 등록일로조회 &nbsp;&nbsp;&nbsp;
						<input type="radio" name="r_search" value="detailed" id="detailed_serach" onClick="fn_enable_detailed_search(this)" />상세조회 &nbsp;&nbsp;&nbsp;
					</TD>
				</TR>
				<TR >
					<TD>
				...
				<tr>
				  <td>
				  	<div class='on_off'>
						...
						<input name="search_content" type="text"  size="30" disabled/>  
						<input  name="search_btn" type="button"  value="조회" disabled/>
					</div>
					  </td>
					</tr>
					<tr>
					  <td>
					  	<div class='on_off'>
						조회한 기간:<input name="bYear"  type="text"  size="4" value="${beginYear}" disabled/>년
								<input  name="bMonth" type="text"  size="4" value="${beginMonth}" disabled/>월	
								 <input  name="bDay" type="text"  size="4" value="${beginDay}" disabled/>일	
								 &nbsp; ~
								<input  name="eYear" type="text"  size="4" value="${endYear }" disabled />년 
								<input  name="eMonth" type="text"  size="4" value="${endMonth }" disabled/>월	
								 <input  name="eDay" type="text"  size="4" value="${endDay }" disabled/>일
						</div>							 
				  </td>
				</tr>
			</TBODY>
